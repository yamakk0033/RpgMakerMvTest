...
(function() {
    ...
    var footStepJson = {
        ...
        always     : {
            interval: 1,
            walk1   : {name: 'se_maoudamashii_se_footstep01_test', volume: 90, pitch: 70, pan: 0},
            walk2   : {name: 'se_maoudamashii_se_footstep01_test', volume: 90, pitch: 70, pan: 0},
            dash1   : {name: 'se_maoudamashii_se_footstep01_test', volume: 90, pitch: 70, pan: 0},
            dash2   : {name: 'se_maoudamashii_se_footstep01_test', volume: 90, pitch: 70, pan: 0},
        },
        // 梯子属性通過時の足音
        ladder     : {
            interval: 1,
